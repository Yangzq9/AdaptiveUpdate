...
al_config = [['', 1.0, 1.0, 1, 'adaptive1'], ['', 1.0, 1.0, 3, 'adaptive1'], ['', 1.0, 1.0, 5, 'adaptive1']]
...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default='train_interval', help="name of the experiment")
...
def train(arglist):
    with U.single_threaded_session():
        ...
        if arglist.restore:
            arglist.exp_name = 'test_interval'
