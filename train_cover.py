...
al_config = [['', 1.0, 1.0, 1, 'adaptive1'], ['', 1.0, 1.0, 1, 'adaptive2'], ['', 1.0, 1.0, 1, 'adaptive3']]
...
def parse_args():
    ...
    # Checkpointing
    parser.add_argument("--exp-name", type=str, default='train_cover', help="name of the experiment")
